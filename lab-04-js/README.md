...
- [ ] Функция `renderPosts(list)` — строит разметку записей и выводит её в контейнер
      `<section id="posts">`.
...
`https://github.com/JLMoodle/diary-blog-template/tree/students/lab-04-js/<Фамилия>`.
